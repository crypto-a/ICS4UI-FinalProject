...
public class EditAnimalPage
{
    ...
    public EditAnimalPage(Event event)
    {
        ...
        //Set validator for the age input
        this.ageField.setInputVerifier(new IntegerInputVerifier());
    ...
    public JPanel requestPage(Animal animal)
    {
        ...
        //Save the values to the inputValues file
        this.pushText(0);
        this.pushText(1);
        this.pushText(2);
        this.pushText(3);
    ...
    {
        //Check if all values are filed
        for (int i = 0; i < 4; i++)
        {
            if (this.event.getInputValues()[i].equals(""))
            {
                //Display error message
                JOptionPane.showMessageDialog(null, "Please Fill Out All Sections", "Error", JOptionPane.ERROR_MESSAGE);
